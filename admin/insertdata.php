...
$deletedata="delete from data60";
mysql_query($deletedata,$conn);
$deletedata1="delete from state";
mysql_query($deletedata1,$conn);
$deletedata2="update user set time='',ip='',usetime=0,score=0,type1=0,type2=0,type3=0,type4=0,sec=0,num=0,secend=0,starttime=''";
...
foreach ($data as $sim){
    ...
    $str11=ltrim($str11,",");
     $sqlid = "insert into data60(info,num) values ".$str11;
    ...
    $str1=ltrim($str1,",");
    $tempsql = "insert into state(sid,flag,info,name,classify,score,result,mark,answer,kind,title,num,content) values ".$str1;
