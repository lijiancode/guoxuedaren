...
$sql2 = "UPDATE addstate SET mark = CASE flag ";
...
if($resultinsert){
    ...
    echo "<meta http-equiv=\"refresh\" content=\"3;url=addresult.php\"/>";
}
else{
    echo "答案提交失败，请重新提交";
    echo "<meta http-equiv=\"refresh\" content=\"3;url=addanswer.php\"/>";
}